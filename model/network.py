    ...
    def __init__(self, name, input_shape, output_dim,
        ...
        with tf.variable_scope(name):
            ...
            for idx, conv_filter, filter_size, stride, pad in zip(
                ...
                print (l_hid.input_shape, "before conv_hidden_%d" % idx)
                l_hid = L.Conv2DLayer(
                    l_hid,
                ...
                print (l_hid.input_shape, " after conv_hidden_%d" % idx)
    ...
    def __init__(self, name, input_shape, extra_input_shape, output_dim, hidden_sizes,
        ...
        with tf.variable_scope(name):
            ...
            for idx, conv_filter, filter_size, stride, pad in zip(
                ...
                print(l_conv_hid,"conv_hidden_%d" % idx )
